<?php
// source: C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/config/config.neon 
// source: C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/config/config.local.neon 

class Container_10227d1bce extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\BasePresenter' => array(array('application.1')),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app',
			'wwwDir' => 'C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/../temp/cache',
	...
	{
		return new Container_10227d1bce_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app/../temp/cache/latte');
...
final class Container_10227d1bce_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
