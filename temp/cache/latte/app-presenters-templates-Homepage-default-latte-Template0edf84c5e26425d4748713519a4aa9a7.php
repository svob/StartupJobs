<?php
// source: C:\Users\Filip\Documents\NetBeansProjects\StartupJobs\app\presenters/templates/Homepage/default.latte

class Template0edf84c5e26425d4748713519a4aa9a7 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f1ad89bac1', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbab49e52042_content')) { function _lbab49e52042_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb827e07220d_title')) { function _lb827e07220d_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb759f3df4be_scripts')) { function _lb759f3df4be_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb34de76425d_head')) { function _lb34de76425d_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
